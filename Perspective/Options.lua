        ...
        profile                                             = {
            default                                         = {
                ...
                names                                       = {
                    ...
                    [L.Unit_Bruxen]                         = { category = "instancePortal",    display = L.Display_Travel_Thayd },
                    [L.Unit_Tanxox]                         = { category = "instancePortal",    display = L.Display_Travel_Thayd },
                    [L.Unit_Gus_Oakby]                      = { category = "instancePortal",    display = L.Display_Travel_Crimson_Badlands },
                    [L.Unit_Lilly_Startaker]                = { category = "instancePortal",    display = L.Display_Travel_Grimvault },
                    [L.Unit_Transportation_Expert_Conner]   = { category = "instancePortal",    display = L.Display_Travel_Farside },
                    [L.Unit_Warrant_Officer_Burke]          = { category = "instancePortal",    display = L.Display_Travel_Whitevale },
                    [L.Unit_Venyanna_Skywind]               = { category = "instancePortal",    display = L.Display_Travel_Northern_Wastes },
                    [L.Unit_Captain_Karaka]                 = { category = "instancePortal",    display = L.Display_Travel_Crimson_Badlands },
                    [L.Unit_Captain_Cryzin]                 = { category = "instancePortal",    display = L.Display_Travel_Grimvault },
                    [L.Unit_Captain_Petronia]               = { category = "instancePortal",    display = L.Display_Travel_Farside },
                    [L.Unit_Captain_Visia]                  = { category = "instancePortal",    display = L.Display_Travel_Whitevale },
                    [L.Unit_Captain_Zanaar]                 = { category = "instancePortal",    display = L.Display_Travel_Northern_Wastes },
                    [L.Unit_Servileia_Uticeia]              = { category = "instancePortal",    display = L.Display_Travel_Ilium },
                ...
                categories = {
                    ...
                    all = {
                        ...
                        module = L.Module_All },
                    eventObjective = {
                        title = L.Category_Event_Objective,
                        module = L.Module_Event,
                        ...
                        iconColor = "ffffff00" },
                    eventInteractable = {
                        title = L.Category_Event_Interactable,
                        module = L.Module_Event,
...
function PerspectiveOptions:InitializeOptions()
    ...
    self:Settings_OpacityInit("OpacitySlider", "opacity", 1, "%")
...
function PerspectiveOptions:Settings_OpacityInit(name, value, numDecimal, unit)
    ...
    if val then
        ...
        if not slider:GetData() then
            -- Set the event handler
            slider:AddEventHandler("SliderBarChanged", "Settings_OnOpacityChanged")
        end
...
function PerspectiveOptions:Settings_OnOpacityChanged(handler, control, button)
    -- Get the control's data
    local data = control:GetData()
    ...
    if val then
        ...
        local opacity = (val * .01) * 255
        local convertedOpacity = string.format("%02X", math.floor(opacity))

        -- Save the value
        self.db.profile[self.profile].settings[data.value] = val
        self.db.profile[self.profile].settings[data.convertedValue] = convertedOpacity
        Perspective.opacity = convertedOpacity
    end
end
